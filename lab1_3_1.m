...
subplot(2,1,1)
to_ret1 = ac_pitch_1(x1 (n), L, M, Fs, Fmin, Fmax);
plot(to_ret1(1,:), to_ret1(2, :))
title('Problem 4b (Actual; Method 1; Constant Frequency)')
xlabel('Sample (n)')
ylabel('Frequency (Hz)')

subplot(2,1,2)
plot(x1_diff)
title('Problem 4b (Expected; Method 1; Constant Frequency)')
xlabel('Sample (n)')
ylabel('Frequency (Hz)')
% TODO: Plot frequency
...
subplot(2,1,1)
to_ret2 = ac_pitch_1(x2 (n), L, M, Fs, Fmin, Fmax);
plot(to_ret2(1,:), to_ret2(2, :))
title('Problem 4b (Actual; Method 1; Linear Frequency)')
xlabel('Sample (n)')
ylabel('Frequency (Hz)')

subplot(2,1,2)
plot(n, x2_diff(n))
title('Problem 4b (Expected; Method 1; Linear Frequency)')
xlabel('Sample (n)')
ylabel('Frequency (Hz)')
% TODO: Plot frequency
...
figure(3)
subplot(2,1,1)
to_ret3 = ac_pitch_1(x(:,1)', L, M, Fs, Fmin, Fmax);
plot(to_ret3(1,:), to_ret3(2, :))
title('Problem 4c (Actual; Method 1)')
xlabel('Sample (n)')
ylabel('Frequency (Hz)')
subplot(2,1,2)
note_length = 11100;
...
plot(x_exp)
title('Problem 4c (Expected; Method 1)')
xlabel('Sample (n)')
ylabel('Frequency (Hz)')
% TODO: Plot frequency
